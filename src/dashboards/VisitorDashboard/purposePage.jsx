...
import PurposeCard from "./purposeSections/purposeCard";
...
function PurposePage() {
  ...
  useEffect(() => {
    ...
    if (location.pathname === "/visitor-dashboard/purpose" && !queryType) {
      setSelectedType("All");
      setPurpose("all");
      return;
    }
  ...
  const handleSelect = (tab) => {
    ...
    if (tab === "All") {
      ...
      setFilters({});
      setPurpose("all");
      navigate("/visitor-dashboard/properties", { replace: true });
    } else if (tab === "Buy") {
  ...
  return (
    <div className="space-y-2 mb-5 relative">
      {/* Tabs */}
      <h2 className="text-2xl text-black font-bold dark:text-white">Available Properties</h2>
      <div className="px-8 mt-5 md:absolute md:left-[0px] md:top-0 md:mt-5">
